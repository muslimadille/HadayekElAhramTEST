...
public class CustomAdabterFinalWidth extends BaseAdapter {
    ...
    public CustomAdabterFinalWidth(Activity context, ArrayList<String> osNameList, ArrayList<Integer> osImages , int color_dd  , String elementone) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        rowView = inflater.inflate(R.layout.sample_gridlayout_sub_width, null);
